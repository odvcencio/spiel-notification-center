...
func generateHTML(webUser, spieler models.User) string {
  ...
  * {
  ...
  <div style="line-height:15px;font-size:1px">&#160;</div>  <a href="https://itunes.apple.com/us/app/spiel-app/id1449212004?mt=8" target="_blank">
      <img class="center  autowidth " align="center" border="0" src="https://s3.amazonaws.com/spieler-photos/appStore.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 120px" width="120">
    </a>
